...
#import "gcChatRegelsViewController.h"

@interface gcChatRegelsViewController ()

@end

@implementation gcChatRegelsViewController
...
- (void)viewDidLoad {
    ...
    url = [url stringByAppendingString:@"chatregels.html"];
