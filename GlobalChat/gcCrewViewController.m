...
#import "gcCrewViewController.h"

@interface gcCrewViewController ()

@end

@implementation gcCrewViewController
...
- (void)viewDidLoad {
    ...
    url = [url stringByAppendingString:@"crew.html"];
